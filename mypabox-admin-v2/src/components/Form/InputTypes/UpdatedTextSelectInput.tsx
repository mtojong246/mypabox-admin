...
export default function UpdatedTextSelectInput({
    label,
    placeholder,
    name,
    value,
    ...
    handleChange: (inputType: "quantity" | "units", value: string | number, name: string) => void,
    ...
    const handleInput = (e: ChangeEvent<HTMLInputElement>) => {
        ...
        handleChange("quantity", Number(e.target.value), name);
        // handleChange(name, inputPath, Number(e.target.value));
    }

    const handleSelect = (e: any) => {
        setUnits(e.value);
        handleChange("units", e.value, name);
