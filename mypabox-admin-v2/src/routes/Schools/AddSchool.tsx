  ...
  return (
    <div className="w-screen py-24 px-10 font-['Noto Sans']">
      ...
      <div className='mt-16 text-md border-b-2 border-black flex justify-start items-end gap-14 w-full max-w-[1200px] overflow-x-scroll'>
        <Link to={{ pathname: '/schools/add-school', hash: '#general-info' }} className='focus:text-orange-500 whitespace-nowrap'>
          General Info
        </Link>
        <Link to={{ pathname: '/schools/add-school', hash: '#degree-info' }} className='focus:text-orange-500 whitespace-nowrap'>
          Degree Info
        </Link>
        <Link to={{ pathname: '/schools/add-school', hash: '#tuition' }} className='focus:text-orange-500 whitespace-nowrap'>
          Tuition
        </Link>
        <Link to={{ pathname: '/schools/add-school', hash: '#GPA' }} className='focus:text-orange-500'>
          GPA</Link>
        <Link to={{ pathname: '/schools/add-school', hash: '#prerequisites' }} className='focus:text-orange-500 whitespace-nowrap'>
          Prerequisites
        </Link>
        <Link to={{ pathname: '/schools/add-school', hash: '#healthcare-experience' }} className='focus:text-orange-500 whitespace-nowrap'>
          Healthcare Experience
        </Link>
        <Link to={{ pathname: '/schools/add-school', hash: '#shadowing' }} className='focus:text-orange-500 whitespace-nowrap'>
          Shadowing
        </Link>
        <Link to={{ pathname: '/schools/add-school', hash: '#GRE' }} className='focus:text-orange-500 whitespace-nowrap'>
          GRE
        </Link>
        <Link to={{ pathname: '/schools/add-school', hash: '#letters-of-recommendation' }} className='focus:text-orange-500 whitespace-nowrap'>
          Letters of Recommendation
        </Link>
        <Link to={{ pathname: '/schools/add-school', hash: '#certifications' }} className='focus:text-orange-500 whitespace-nowrap'>
          Certifications
        </Link>
        <Link to={{ pathname: '/schools/add-school', hash: '#additional-notes' }} className='focus:text-orange-500 whitespace-nowrap'>
          Additional Notes
        </Link>
      </div>
