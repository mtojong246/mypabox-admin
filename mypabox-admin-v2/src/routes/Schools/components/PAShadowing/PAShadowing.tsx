        ...
        {newSchool && (
            <>
                <div className={`mt-10 relative max-w-[900px] border p-5 block rounded border-[#B4B4B4]`}>
                    ...
                    <div className={`w-full ${newSchool.school_pa_shadowing_required.input ? 'mt-8' : 'mt-4'}`}>
                ...
                <div className={`mt-20 relative max-w-[900px] border p-5 block rounded border-[#B4B4B4]`}>
                    ...
                    <div className={`w-full ${newSchool.school_pa_shadowing_recommended.input ? 'mt-8' : 'mt-4'}`}>
