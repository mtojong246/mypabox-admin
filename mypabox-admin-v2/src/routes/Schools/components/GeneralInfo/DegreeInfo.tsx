    ...
    return (
        <>
            <div className={`mt-12 relative max-w-[900px] border-2 p-4 block rounded border-[#B4B4B4]`}>
                ...
                <button value="school_type_of_degree_offered" className="w-56 pl-4 text-red-500 border border-[#F06A6A] rounded h-[50px] text-xl" 
                onClick={addInputFields}>
                <AiOutlinePlus className="absolute ml-2 mt-[6px]"/>
                Add more fields
                </button>
                <button value="school_type_of_degree_offered" className="w-32 ml-3 border text-red-500 border-[#F06A6A] rounded h-[50px] text-xl" 
