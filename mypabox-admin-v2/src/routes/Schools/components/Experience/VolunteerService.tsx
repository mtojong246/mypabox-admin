...
import { Dispatch, SetStateAction, useEffect, ChangeEvent, useState } from "react"
...
export default function VolunteerService({ newSchool, setNewSchool }: { newSchool: School, setNewSchool: Dispatch<SetStateAction<School>> }) {
    ...
    return (
        ...
        <div className={`mt-20 relative max-w-[900px] border py-5 px-8 block rounded border-[#B4B4B4]`}>
            <label className="absolute top-[-16px] left-[20px] text-xl bg-white">Volunteer Service</label>   
            
            <div className={`mt-7 relative max-w-[900px] p-5 block rounded-lg ${newSchool.school_volunteer_service.school_volunteer_service_required ? 'border-[#4573D2] border-2' : 'border-[#545454] border'}`}>
                ...
                <div className={`mt-7 mx-5 mb-5 relative max-w-[900px] border p-5 block rounded-lg border-[#545454]`}>
                    ...
                    <button onClick={(e) => {toggleNotePopup(e); setIsGroup(false); setName('school_minimum_volunteer_service_hours_required'); setNoteName('school_minimum_volunteer_service_hours_required_notes')}} className="border text-[#F06A6A] border-[#F06A6A] rounded-md h-14 px-5 text-xl hover:text-white hover:bg-[#F06A6A]">
                        Add Note
                    </button>
            ...
            <div className={`mt-12 relative max-w-[900px] p-5 block rounded-lg ${newSchool.school_volunteer_service.school_volunteer_service_recommended ? 'border-[#4573D2] border-2' : 'border-[#545454] border'}`}>
                ...
                {newSchool.school_volunteer_service.school_minimum_volunteer_service_hours_recommended && (
                <div className={`mt-7 mx-5 mb-5 relative max-w-[900px] border p-5 block rounded-lg border-[#545454]`}>
                    ...
                    <button onClick={(e) => {toggleNotePopup(e); setIsGroup(false); setName('school_minimum_volunteer_service_hours_recommended'); setNoteName('school_minimum_volunteer_service_hours_recommended_notes')}} className="border text-[#F06A6A] border-[#F06A6A] rounded-md h-14 px-5 text-xl hover:text-white hover:bg-[#F06A6A]">
                        Add Note
                    </button>
