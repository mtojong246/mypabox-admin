...
export default function Certifications({ newSchool, setNewSchool, loggedInUser, isEdit }: { newSchool: School, setNewSchool: Dispatch<SetStateAction<School>>, loggedInUser: UserObject, isEdit: boolean }) {
    ...
    return (
        ...
        <div className={`mt-10 flex justify-start items-start gap-3 w-full`}>
            ...
            {((loggedInUser.permissions.canVerify && newSchool.edited_school_certifications_required.input !== null) || (!loggedInUser.permissions.canVerify && !newSchool.edited_school_certifications_required.isEditMode)) && <div className='absolute top-0 bottom-0 right-0 left-0 bg-[#e8e8e8] opacity-50 z-10'></div>}
