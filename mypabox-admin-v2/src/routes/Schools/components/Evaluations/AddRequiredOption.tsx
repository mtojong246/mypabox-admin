            ...
            editedOptions && setNewSchool({
                ...
                edited_school_evaluations_required: {
                    ...
                    edited_school_optional_evaluators_required: {
                        ...
                        input: newSchool.edited_school_evaluations_required.edited_school_optional_evaluators_required.input ? newSchool.edited_school_evaluations_required.edited_school_optional_evaluators_required.input.concat(editedOptions)
                        : [editedOptions],
                    }
                }
            })
            ...
            <div className='fixed bg-[rgba(0,0,0,0.2)] top-0 left-0 right-0 bottom-0 flex justify-center items-center p-10'>
                <div className='relative w-full max-w-[900px] max-h-[700px] overflow-y-scroll rounded-lg p-4 bg-white'>
                    ...
                    <div className='w-full mb-8'>
                        ...
                        <InputFields isEdit={isEdit} newSchool={newSchool} loggedInUser={loggedInUser} isEditMode={newSchool.edited_school_evaluations_required.isEditMode} input={editedOptions ? editedOptions.school_minimum_number_of_evaluators_required_in_group : null} originalInput={options.school_minimum_number_of_evaluators_required_in_group}
                    ...
                    <div className='w-full mb-8'>
                        ...
                        <SelectInputsFields isEdit={isEdit} loggedInUser={loggedInUser} isEditMode={newSchool.edited_school_evaluations_required.isEditMode} input={editedOptions ? editedOptions.school_minimum_time_evaluator_knows_applicant : null} originalInput={options.school_minimum_time_evaluator_knows_applicant} 
