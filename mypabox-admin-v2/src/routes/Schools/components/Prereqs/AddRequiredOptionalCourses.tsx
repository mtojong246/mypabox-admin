...
export default function AddRequiredOptionalCourses({ toggleRequiredOptionalCourses }: { toggleRequiredOptionalCourses: (e:any) => void }) {
    return (
            ...
            <div className='fixed bg-[rgba(0,0,0,0.2)] top-0 left-0 right-0 bottom-0 flex justify-center items-center p-10'>
                <div className='w-full max-w-[900px] max-h-[800px] overflow-y-scroll rounded-lg p-4 bg-white'>
                    ...
                    <div className='w-full flex justify-end items-center gap-3'>
                        ...
                        <button className='border-2 border-[#4573D2] bg-[#4573D2] text-white font-medium px-3 py-2 rounded-md'>Add Option</button>
                    </div>
                </div>
            </div>
        </div>
