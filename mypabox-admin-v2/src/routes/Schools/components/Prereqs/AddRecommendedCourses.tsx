            ...
            <div className='fixed bg-[rgba(0,0,0,0.2)] top-0 left-0 right-0 bottom-0 flex justify-center items-center p-10'>
                <div className='w-full max-w-[900px] rounded p-4 bg-white'>
                    ...
                    <div className='w-full mb-14'>
                        ...
                        <ReactQuill readOnly={loggedInUser.permissions.canVerify ? false : true} className='mt-2 h-[200px] rounded w-full' theme="snow" onChange={handleNote} value={recommendedCourse.school_recommended_course_note_section}/>
                    </div>
