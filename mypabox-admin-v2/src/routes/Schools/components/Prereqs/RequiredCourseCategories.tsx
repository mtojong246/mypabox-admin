...
export default function RequiredCourseCategories({ newSchool, setNewSchool, loggedInUser, isEdit }: { 
    ...
    return (
        <>
            ...
            {((loggedInUser.permissions.canVerify && newSchool.edited_school_prereq_required_course_categories.input !== null) || (!loggedInUser.permissions.canVerify && !newSchool.edited_school_prereq_required_course_categories.isEditMode)) && <div className='absolute top-0 bottom-0 right-0 left-0 bg-[#e8e8e8] opacity-50 z-10'></div>}
