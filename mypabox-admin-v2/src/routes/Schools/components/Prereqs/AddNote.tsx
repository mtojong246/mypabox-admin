...
export default function AddNote({ toggleNotePopup, addNote }: { toggleNotePopup: (e:any) => void, addNote: (note: Note) => void }) {
        ...
        <div className='fixed top-0 left-0 right-0 bottom-0 z-10'>
            <div className='fixed bg-[rgba(0,0,0,0.2)] top-0 left-0 right-0 bottom-0 flex justify-center items-center p-10'>
                <div className='w-full max-w-[900px] rounded-lg p-4 bg-white'>
                    <p className='text-xl font-semibold mb-8'>Add Note to Required Optional Group</p>
                    ...
                    <div className='w-full flex justify-end items-center gap-3'>
                        ...
                        <button onClick={(e) => {toggleNotePopup(e); addNote(optionalNote)}} className='border-2 border-[#4573D2] bg-[#4573D2] text-white font-medium px-3 py-2 rounded-md'>Add note</button>
                    </div>
                </div>
            </div>
        </div>
