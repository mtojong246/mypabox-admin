      ...
      {dataArray.map((data, i) => {
        ...
        return (
         <div className={`${
          ...
          >
            {((loggedInUser.permissions.canVerify && (newSchool[`edited_${data.value}` as keyof School] as any).input !== null) || (!loggedInUser.permissions.canVerify && !(newSchool[`edited_${data.value}` as keyof School] as any).isEditMode)) && <div className='absolute top-0 bottom-0 right-0 left-0 bg-[#999999] opacity-50 z-10'></div>}
