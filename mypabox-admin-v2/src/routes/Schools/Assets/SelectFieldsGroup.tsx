...
export default function SelectFieldsGroup({loggedInUser, input, originalInput, isEditMode, name, category, options, handleSelect, label, originalLabel, handleSelectInArray, index}: {
