        ...
        <div className='fixed top-0 left-0 right-0 bottom-0 z-10'>
            <div className='fixed bg-[rgba(0,0,0,0.2)] top-0 left-0 right-0 bottom-0 flex justify-center items-center p-10'>
                <div className='w-full max-w-[900px] rounded p-4 bg-white'>
                    <p className='text-xl font-medium mb-4'>Add subcategory to "{category.category_name}"</p>
                    <Select className="w-full focus:outline-none rounded mb-4"
                    ...
                    <div className='w-full flex justify-end items-center gap-3'>
                        <button onClick={toggleSubPopup} className='border-2 border-[#B4B4B4] bg-none text-[#B4B4B4] font-medium px-3 py-2 rounded'>Cancel</button>
                        <button onClick={handleSelect} className='border-2 border-[#4573D2] bg-[#4573D2] text-white font-medium px-3 py-2 rounded'>Add subcategory</button>
                    </div>
                </div>
            </div>
        </div>
